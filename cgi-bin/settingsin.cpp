...
std::vector<Store*> RemoteServices;
  ...
  */
  ...
  ////////////////////////////////////////////////////////////
    ...
    cout<<"<form  action=\"/cgi-bin/settingsin2.cgi\" method=\"post\" >";
   ...
   while ((dp=readdir(dirp)) !=NULL){
     ...
     //cout<<"<option value=\""<<dp->d_name<<"\">"<<file.substr(file.length()-1,1)<<"</option>";
     if(comp==file.substr(0, comp.length()) && file.substr(file.length()-1,1)!="~")cout<<"<option value=\""<<dp->d_name<<"\">"<<dp->d_name<<"</option>";

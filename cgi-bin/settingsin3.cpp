...
std::vector<Store*> RemoteServices;
  ...
  */
  ...
  form_iterator fi3 = formData.getElement("filename");
  if( !fi3->isEmpty() && fi3 != (*formData).end()) {
    ...
    if (myfile.is_open())
      {
	form_iterator fi4 = formData.getElement("Text1");
	if( !fi4->isEmpty() && fi4 != (*formData).end()) {

	  myfile << **fi4;
          myfile.close();
	}
      }
    cout << "Written to file "<< **fi3 << endl;
  }
  ...
  ////////////////////////////////////////////////////////////
    ...
    form_iterator fi = formData.getElement("type");                                                                                                                        
    if( !fi->isEmpty() && fi != (*formData).end()) {                                                                                                                       
       
	
	if(**fi=="Beam") cout<<"<option value=\"Beam\" selected>Beam</option>";
	else     cout<<"<option value=\"Beam\">Beam</option>";
      if(**fi=="LED")cout<<"<option value=\"LED\" selected>LED</option>";
      else cout<<"<option value=\"LED\">LED</option>";
      if(**fi=="Soft")cout<<"<option value-\"Soft\" selected>Soft</option>";
      else cout<<"<option value=\"Soft\">Soft</option>";
    //}                                                                                                                                                                  
    }
    

    cout<<"</select></td><td>";
    cout<<"<input type=\"submit\" value=\"Select\" /></form></td><td></tr><tr><td> File</td><td>";
    cout<<"<form action=\"/cgi-bin/settingsin2.cgi\" method=\"post\" id=\"form1\" >";
    cout<<"<input type=\"hidden\" name=\"type\" value=\""<<**fi<<"\">"; 
    cout<<"<div align='center'>";
    cout<<"<select name=\"file\">";
   ...
   form_iterator fi2 = formData.getElement("file"); 
   
   while ((dp=readdir(dirp)) !=NULL){
     string file=dp->d_name;
     if(comp==file.substr(0, comp.length()) && file.substr(file.length()-1,1)!="~")cout<<"<option value=\""<<dp->d_name<<"\"";
     if(file==**fi2) cout<<" selected";
     cout<<">"<<dp->d_name<<"</option>";
     
   }
   
   cout<<"</select></td><td>";
   cout<<"<input type=\"submit\" value=\"Open\" /></form>";
...
cout<<"</td></tr></table>";
  ...
  if( !fi2->isEmpty() && fi2 != (*formData).end()) {                                                                                                                     
    ...
    string filename="./configfiles/"+**fi2;
    cout<<filename;
    cout<<"<form action=\"/cgi-bin/settingsin3.cgi\" method=\"post\" id=\"form2\" >";
    cout<<"<input type=\"hidden\" name=\"type\" value=\""<<**fi<<"\">"; 
    cout<<"<input type=\"hidden\" name=\"file\" value=\""<<**fi2<<"\">"; 
    cout<<"  <td> <input type=\"text\" name=\"filename\" value=\""<<filename<<"\">";
    cout<<"<input type=\"submit\" value=\"Save\" /></form>";


   cout<<"  <table  border=\"1\" align=\"center\">";
   //cout<<"  <td> <input type=\"text\" name=\"filevalue\" value=\"";
    cout<<" <td> <textarea name=\"Text1\" typename=\"Text1\" cols=\"160\" form=\"form2\" rows=\"50\">";
 string line;

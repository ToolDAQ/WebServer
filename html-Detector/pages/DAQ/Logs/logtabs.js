...
tab.setAttribute('href', '/pages/DAQ/Logs/logs.html');
tab.addEventListener('click', function() {
  window.open('/pages/DAQ/Logs/logs.html', '_self');
});
...
tab2.setAttribute('href', '/pages/DAQ/Logs/index.html');
tab2.addEventListener('click', function() {
  window.open('/pages/DAQ/Logs/index.html', '_self');
});

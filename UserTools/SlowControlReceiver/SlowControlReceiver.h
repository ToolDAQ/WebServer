#ifndef SlowControlReceiver_H
#define SlowControlReceiver_H
...
*/
class SlowControlReceiver: public Tool {


 public:

  SlowControlReceiver(); ///< Simple constructor

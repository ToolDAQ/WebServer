#ifndef ExampleSlowControl_H
#define ExampleSlowControl_H
...
*/
class ExampleSlowControl: public Tool {


 public:

  ExampleSlowControl(); ///< Simple constructor
